            ...
            <body>
                <div class="d-flex flex-column wrapper">
                    <main class="flex-fill">
                        <div class="container">
                            <h2>1. Termos</h2>
                            <p>Ao acessar ao site <a href='http://www.dominio.com'>Casa dos Bonés</a>, concorda em cumprir estes
                            ...
                            <p>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software)
                                no site Casa dos Bonés , apenas para visualização transitória pessoal e não comercial. Esta é a
                            ...
                            <ol>
                                ...
                                <li>usar os materiais para qualquer finalidade comercial ou para exibição pública (comercial ou não
                                    comercial); </li>
                                <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Casa dos
                                    Bonés;
                                </li>
                            ...
                            <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser
                                rescindida por Casa dos Bonés a qualquer momento. Ao encerrar a visualização desses materiais ou
                            ...
                            <ol>
                                <li>Os materiais no site da Casa dos Bonés são fornecidos 'como estão'. Casa dos Bonés não oferece
                                ...
                                <li>Além disso, o Casa dos Bonés não garante ou faz qualquer representação relativa à precisão, aos
                            ...
                            <h2>4. Limitações</h2>
                            <p>Em nenhum caso o Casa dos Bonés ou seus fornecedores serão responsáveis ​​por quaisquer danos
                                (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios)
                                decorrentes do uso ou da incapacidade de usar os materiais em Casa dos Bonés, mesmo que Casa dos
                                Bonés ou um representante autorizado da Casa dos Bonés tenha sido notificado oralmente ou por
                            ...
                            <p>Os materiais exibidos no site da Casa dos Bonés podem incluir erros técnicos, tipográficos ou
                                fotográficos. Casa dos Bonés não garante que qualquer material em seu site seja preciso, completo
                                ou atual. Casa dos Bonés pode fazer alterações nos materiais contidos em seu site a qualquer
                                momento, sem aviso prévio. No entanto, Casa dos Bonés não se compromete a atualizar os materiais.
                            </p>
                            <h2>6. Links</h2>
                            <p>O Casa dos Bonés não analisou todos os sites vinculados ao seu site e não é responsável pelo
                                conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por Casa dos
                                Bonés do site. O uso de qualquer site vinculado é por conta e risco do usuário.</p>
                            <p/>
                            <h3>Modificações</h3>
                            <p>O Casa dos Bonés pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio.
                                Ao usar este site, você concorda em ficar vinculado à versão atual desses termos de serviço.</p>
                            <h3>Lei aplicável</h3>
                            <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Casa dos Bonés e você
