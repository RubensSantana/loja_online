                ...
                <div className="d-flex flex-column wrapper">
                    <main className="flex-fill">
                        <div className="container">
                            ...
                            <p>A sua privacidade é importante para nós. É política da Casa dos Bonés respeitar a sua privacidade em
                                relação a qualquer informação sua que possamos coletar no site <a href="http://www.dominio.com">Casa dos Bonés</a>, e outros sites que possuímos e operamos.</p>
                            <p />
                            ...
                            <h2>Política de Cookies Casa dos Bonés</h2>
                            ...
                            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Casa dos Bonés
                            ...
                            <ul>
                                ...
                                <li>B) Não divulgar conteúdo ou propaganda de natureza racista, xenofóbica, <a
                                    href='https://ondeapostar.pt/' id="ondeapostar">casas de apostas
                                    online</a>, pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                                </li>
                                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Casa dos Bonés,
                            ...
                            <p>Esta política é efetiva a partir de <strong>janeiro de </strong><strong>2024</strong>.</p>
                        </div>
                    </main>
                </div >
            </body >
